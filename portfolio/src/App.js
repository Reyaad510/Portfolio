          ...
          <div>
            ...
            <div className="p-contain">
              <p>
                ...
                create a website after being given a design from product
                manager.
              </p>
            </div>
          ...
          <div className="blackhole">
            ...
            <div className="p-contain">
              <p className="p-contain">
                Sometimes, you just need to vent to get it out, move on, and
                feel better. Enter black hole. Blackhole is a reverse note
                taking app. Type away your frustrations and watch it get sucked
                into the blackhole!
              </p>
            </div>
            <button className="project-button">
